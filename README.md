...
# [🇺🇸 Eng](https://github.com/akvarium11/AkvariumMacros#header) | [🇷🇺 Rus](https://github.com/akvarium11/AkvariumMacros#header-rus)
...
*AkvariumMacros* is a collection of Minecraft macros for gaining advantage over others written in pure C/C++. This app has modern anti-detection algorithms and does not interfere with games code due to it being external.

> [!IMPORTANT]  
> All binary in ./drawing/imgui is taken from [Dear ImGui official repo](https://github.com/ocornut/imgui)
...
## <a id="header-rus"></a>📖 Содержание
- [О проекте](https://github.com/akvarium11/AkvariumMacros#about-the-project-rus)
...
*AkvariumMacros* — это набор макросов для Minecraft, которые дают преимущество над другими игроками. Написан полностью на чистом C/C++. У приложения современные алгоритмы анти-детекта, и оно не лезет в код игры, потому что использует external overlay.

> [!IMPORTANT]  
> Весь binary в `./drawing/imgui` взяты из [официального репозитория Dear ImGui](https://github.com/ocornut/imgui)
